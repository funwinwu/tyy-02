 ...
 */
class Mage_CatalogSearch_Block_Popular extends Mage_Core_Block_Template
{
    protected $_suggestData = null;
    private $keywords_count = 10;

    protected function ddddHtml()
    {
        $html = '';
    ...
    public function getSuggestData()
    {
        if (!$this->_suggestData) {
            ...
            foreach ($collection as $item) {
            	if( count( $data ) >= $this->keywords_count ) break;
