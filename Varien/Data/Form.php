...
class Varien_Data_Form extends Varien_Data_Form_Abstract
{
	...
	/*add by ken. 20100422. start 1.*/
	protected $_after_replace = array();
	/*add by ken. 20100422. end 1.*/
    ...
    public function toHtml()
    {
		...
		/*add by ken. 20090903. start 1*/
        if( !empty( $this->_after_replace ) ){
        	foreach( $this->_after_replace as $pattern_replacement ){        		
        		$html = eregi_replace( $pattern_replacement['pattern'],$pattern_replacement['replacement'],$html );       
        	}
        }
        /*add by ken. 20090903. end 1*/
        return $html;
    }
	...
	/*add by ken. 20090903. start 2*/
     public function addReplacement( $pattern,$replacement )
     {
     	$this->_after_replace[] = array( 'pattern' => $pattern,'replacement' => $replacement  );
     }
     /*add by ken. 20090903. end 2*/
}
