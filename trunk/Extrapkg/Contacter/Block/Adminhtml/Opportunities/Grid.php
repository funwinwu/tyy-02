...
class Extrapkg_Contacter_Block_Adminhtml_Opportunities_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('opportunitiesGrid');
      $this->setDefaultSort('contacter_id');      
      $this->setDefaultDir('DESC');
      $this->setData("opportunitiesGridfilter", array("type"=>2));
      Mage::getSingleton('adminhtml/session')->setData("opportunitiesGridfilter", array("type"=>2));
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('conpany_name', array(
          'header'    => Mage::helper('contacter')->__('Company name'),
          'align'     =>'left',
          'index'     => 'conpany_name',
      ));
      
      $this->addColumn('business_nuture', array(
          'header'    => Mage::helper('contacter')->__('Nature of business'),
          'align'     =>'left',
