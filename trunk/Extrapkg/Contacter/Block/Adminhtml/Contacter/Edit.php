...
class Extrapkg_Contacter_Block_Adminhtml_Contacter_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('contacter')->__('Save Item'));
        $this->_updateButton('delete', 'label', Mage::helper('contacter')->__('Delete Item'));
