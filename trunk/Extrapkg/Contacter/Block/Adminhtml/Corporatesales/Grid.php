...
class Extrapkg_Contacter_Block_Adminhtml_Corporatesales_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('corporatesalesGrid');
      $this->setDefaultSort('contacter_id');      
      $this->setDefaultDir('DESC');
      $this->setData("corporatesalesGridfilter", array("type"=>3));
      Mage::getSingleton('adminhtml/session')->setData("corporatesalesGridfilter", array("type"=>3));
  ...
  protected function _prepareCollection()
  {
	...
	protected function _filterCountryCondition($collection, $column)
	{
		if (!$value = $column->getFilter()->getValue()) {
			return;
		}

		$this->getCollection()->addCountryFilter($value);
	}
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('country', array(
                'header'        => Mage::helper('contacter')->__('Country'),
                'index'         => 'country',
                'type'          => 'country',
                'store_all'     => true,
                'store_view'    => true,
                ...
                'filter_condition_callback'
                                => array($this, '_filterCountryCondition'),
            ));
