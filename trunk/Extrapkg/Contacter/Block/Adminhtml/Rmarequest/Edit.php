...
class Extrapkg_Contacter_Block_Adminhtml_Rmarequest_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('contacter')->__('Save this rma request'));
        $this->_updateButton('delete', 'label', Mage::helper('contacter')->__('Delete this rma request'));
