...
class Extrapkg_Contacter_Block_Adminhtml_Rmarequest_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
...
//      ));
      ...
      $fieldset->addField('first_name', 'text', array(
       ...
       $fieldset->addField('tel', 'text', array(
          'label'     => Mage::helper('contacter')->__('Order Number'),
          'class'     => 'required-entry',
          'required'  => true,
          'name'      => 'tel',
      ));
      ...
      $fieldset->addField('conpany_name', 'text', array(
          'label'     => Mage::helper('contacter')->__('Part Number'),
          'class'     => 'required-entry',
          'required'  => true,
          'name'      => 'conpany_name',
      ));
