...
class Extrapkg_Contacter_Block_Adminhtml_Opportunities_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('country', 'select', array(
             ...
             $fieldset->addField('business_nuture', 'text', array(
          'label'     => Mage::helper('contacter')->__('Nature of business'),
