...
class Extrapkg_Contacter_Block_Adminhtml_Corporatesales_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_corporatesales';
        
        $this->_updateButton('save', 'label', Mage::helper('contacter')->__('Save this business opportunity'));
        $this->_updateButton('delete', 'label', Mage::helper('contacter')->__('Delete this business opportunity'));
