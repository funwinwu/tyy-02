...
class Extrapkg_Contacter_Block_Adminhtml_Rmarequest_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('rmarequestGrid');
      $this->setDefaultSort('contacter_id');      
      $this->setDefaultDir('DESC');
      $this->setData("rmarequestGridfilter", array("type"=>5));
      Mage::getSingleton('adminhtml/session')->setData("rmarequestGridfilter", array("type"=>5));
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('first_name', array(
	   ...
	   $this->addColumn('tel', array(
          'header'    => Mage::helper('contacter')->__('Order Number'),
          'align'     =>'left',
		  'width'     => '200px',
          'index'     => 'tel',
      ));
	    ...
	    $this->addColumn('conpany_name', array(
          'header'    => Mage::helper('contacter')->__('Part number'),
          'align'     =>'left',
          'index'     => 'conpany_name',
      ));
