...
class Extrapkg_Contacter_Block_Adminhtml_Contacter_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('contacterGrid');
      $this->setDefaultSort('contacter_id');
      $this->setDefaultDir('DESC');
      $this->setData("contacterGridfilter", array("type"=>1));
      Mage::getSingleton('adminhtml/session')->setData("contacterGridfilter", array("type"=>1));
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('product_code', array(
          'header'    => Mage::helper('contacter')->__('Product code'),
          'align'     =>'left',
          'index'     => 'product_code',
      ));
