 ...
 */
class Uplai_Repay_Block_Checkout_Payment_Methods extends Mage_Checkout_Block_Onepage_Payment_Methods
{
    public function getOrder()
    {
        return Mage::getSingleton('checkout/session')->getOrder();
    }
    ...
    public function getMethods()
    {
        ...
        if (is_null($methods) || 1 ) {
        	$order = $this->getOrder();   
            $store = $order ? $order->getStoreId() : null;
            $methods = $this->helper('payment')->getStoreMethods($store);
